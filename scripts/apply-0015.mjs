/**
 * Aplica drizzle/0015_card_statements.sql (tabla card_statements + expenses.statement_id).
 *   node scripts/apply-0015.mjs
 */
...
const migration = readFileSync(
  new URL("../drizzle/0015_card_statements.sql", import.meta.url),
  "utf8",
);
